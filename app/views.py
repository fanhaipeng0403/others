...
class AdminBIUserModelView(AdminBaseModelView):
    ...
    column_list = ['user_id', 'email', 'username', 'account_status', 'dollar_paid_amount', 'email_validate_time',
                   'reg_time', 'last_poker_time', 'gold_balance', 'last_slots_time', 'silver_balance']
    column_searchable_list = ['user_id', 'og_account', 'email', 'username']
    column_sortable_list = ['user_id', 'dollar_paid_amount', 'email_validate_time', 'reg_time', 'last_poker_time',
                            'gold_balance', 'last_slots_time', 'silver_balance']
...
class AdminBIClubWPTUserModelView(AdminBaseModelView):
    def exchanged_user_id_formatter(v, c, m, p):
        return Markup('<a href="/data/bi_user/details/?user_id=%s" target="_blank">%s</a>' % (
        m.exchanged_user_id, m.exchanged_user_id))
